...
export PATH="$HOME/.rbenv/bin:$PATH:$HOME/localdevs/flutter/bin"
export PATH="$PATH:/opt/android-studio/bin:/opt/thunderbird/bin"
export PATH="$PATH:$HOME/localdevs/flutter/.pub-cache/bin"
export PATH="$PATH:$HOME/Android/Sdk/emulator:$HOME/Android/Sdk/platform-tools"
export PATH="$PATH:/snap/bin"
export PATH="$PATH:/home/ecl/local/bin"
eval "$(rbenv init -)"
export PATH="$PATH:/home/ecl/.pub-cache/bin"
